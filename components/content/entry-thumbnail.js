...
var entry_thumbnail = function() {
  ...
  console.log('hola');
	...
	if (
      (document.querySelector( 'body' ).hasClass( 'page' ) || document.querySelector( 'body' ).hasClass( 'single' ))
    && document.querySelector( '.hentry-wrapper' ).hasClass( 'has-post-thumbnail' )
  ) {
		...
		elements = document.querySelectorAll( '.entry-thumbnail' );
